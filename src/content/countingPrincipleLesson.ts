...
export const countingPrincipleLesson: Lesson = {
  ...
  steps: [
    ...
    },
    {
      ...
      type: 'product-grid',
      title: 'At the Diner',
      body: 'A diner offers 3 main dishes and 5 drinks, where a meal is one main with one drink. Tap each main to pair it with all 5 drinks and watch the meals add up.',
      productGridConfig: {
        rowLabel: 'main',
        colLabel: 'drink',
        rows: 3,
      ...
      feedback: {
        correct:
          'Every main pairs with all 5 drinks: 3 mains × 5 drinks = 15 meals. Each new main adds another full row of drinks, so the counts multiply.',
        incorrect: '',
        hint: 'Each main can be paired with any drink, so the full set of drinks repeats for every main — repeated sets multiply.',
        computationHint: '3 mains × 5 drinks = 15 meals (three rows of five).',
      },
      concepts: ['counting-principle'],
    },
    {
